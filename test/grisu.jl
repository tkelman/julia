...
function trimrep(buffer)
  len = length(String(pointer(buffer)))
  ind = len
  for i = len:-1:1
    buffer[i] != 0x30 && break
    ind -= 1
...
@test "4294967295" == String(pointer(buffer))
@test 10 == point
fill!(buffer,0)

status,len,point = Grisu.fastfixedtoa(4294967296.0, 0,5, buffer)
@test "4294967296" == String(pointer(buffer)) #todo
@test 10 == point
fill!(buffer,0)

status,len,point = Grisu.fastfixedtoa(1e21, 0,5, buffer)
@test "1" == String(pointer(buffer)) #todo extra '0's
@test 22 == point
fill!(buffer,0)
...
@test "1000000001" == String(pointer(buffer))
@test 0 == point
fill!(buffer,0)
...
@test "91193616301674545152" == String(pointer(buffer))
@test 20 == point
fill!(buffer,0)

status,len,point = Grisu.fastfixedtoa(4.8184662102767651659096515e-04, 0,19,buffer)
@test "4818466210276765" == String(pointer(buffer))
@test -3 == point
fill!(buffer,0)
...
@test "1000000000000000128" == String(pointer(buffer))
@test 19 == point
fill!(buffer,0)
...
@test "4294967272" == String(pointer(buffer))
@test 10 == point
fill!(buffer,0)
map(x->Grisu.Bignums.zero!(x),bignums)

status,len,point = Grisu.bignumdtoa(4294967272.0, Grisu.FIXED, 5, buffer,bignums)
@test "429496727200000" == String(pointer(buffer))
@test 10 == point
fill!(buffer,0)
map(x->Grisu.Bignums.zero!(x),bignums)
...
@test "15498" == String(pointer(buffer)) #todo
@test 1 == point
fill!(buffer,0)
...
@test "42949673" == String(pointer(buffer))
@test 10 == point
fill!(buffer,0)
...
@test "4185580496821357" == String(pointer(buffer))
@test 299 == point
fill!(buffer,0)
...
@test "5562684646268003" == String(pointer(buffer))
@test -308 == point
fill!(buffer,0)
...
@test 1 == neg
@test "2147483648" == String(pointer(buffer))
@test 10 == point
fill!(buffer,0)

len,point,neg = Grisu.grisu(Float32(-2147483648.), Grisu.SHORTEST, 0, buffer)
@test 1 == neg
@test "21474836" == String(pointer(buffer))
@test 10 == point
fill!(buffer,0)
...
@test 1 == neg
@test "35844466002796428" == String(pointer(buffer))
@test 299 == point
fill!(buffer,0)
...
v = reinterpret(Float64,0x000FFFFFFFFFFFFF)
len,point,neg = Grisu.grisu(v, Grisu.SHORTEST, 0, buffer)
@test "2225073858507201" == String(pointer(buffer))
@test -307 == point
fill!(buffer,0)

f = reinterpret(Float32,0x007FFFFF)
len,point,neg = Grisu.grisu(f, Grisu.SHORTEST, 0, buffer)
@test "11754942" == String(pointer(buffer))
@test -37 == point
fill!(buffer,0)
...
@test 0 == neg
@test "4128420500802942" == String(pointer(buffer))
@test -8 == point
fill!(buffer,0)

v = -3.9292015898194142585311918e-10
len,point,neg = Grisu.grisu(v, Grisu.SHORTEST, 0, buffer)
@test "39292015898194143" == String(pointer(buffer))
fill!(buffer,0)

f = Float32(-3.9292015898194142585311918e-10)
len,point,neg = Grisu.grisu(f, Grisu.SHORTEST, 0, buffer)
@test "39292017" == String(pointer(buffer))
fill!(buffer,0)
