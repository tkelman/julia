...
if [ `arch` = x86_64 ]; then
  ...
  x86_64-w64-mingw32-ar cr llvm/lib/libgtest.a
  x86_64-w64-mingw32-ar cr llvm/lib/libgtest_main.a
...
make -C depsget-openblas get-lapack get-uv get-double-conversion get-openlibm get-openspecfun get-random \
